...
int pil(int a, int b){
	return GetPixel(offscreen_DC, gXCenter + a, gYCenter - b);
}
extern int GP142_FUNC
...
/******************************************************* GP142_circle() ***/
extern int GP142_FUNC
GP142_circleXY (int color, int x, int y, int radius,int with)
{
    GP142_point p;
    ...
    return GP142_circleP(color, p, radius,with);
}
    
extern int GP142_FUNC
GP142_circleP (int color, GP142_point center, int radius,int with)
{
    Graphics new_item;
